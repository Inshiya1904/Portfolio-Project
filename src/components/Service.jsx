...
const services = [
  {
    ...
    description:
      "Building robust backend systems using PHP, APIs, and databases.",
  },
  {
    id: 2,
    title: "Full-Stack Development",
    description:
      "Developing scalable applications using MERN and modern technologies.",
  },
  {
    id: 3,
    title: "System Maintenance & Debugging",
    description:
      "Maintaining production systems and resolving real-time issues efficiently.",
  },
];
